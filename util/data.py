...
class Data:
    ...
    def _success_message(self):
        ...
        print(f"Constituent seed: {int(self.seed or 0):,}")
        print(f"Jet seed: {int(self.jet_seed or 0):,}")
        print("If the seed is 0 it means no seed was given, i.e.,  NoneType.")
        print("The seed is not actually 0 but a random number.")
        print("----------------\n")

...
hls4ml.converters.register_keras_layer_handler('BroadcastSubtract', parse_bcast_subtract_layer)
...
hls_model = hls4ml.converters.convert_from_keras_model(deepsets_network, hls_config=config, output_dir=outname)
hls_model.compile()

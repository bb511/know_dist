...
if __name__ == "__main__":
    ...
    hls_model = hls4ml.converters.convert_from_keras_model(
        model, hls_config=config, output_dir=outname, part="xcvu9p-flgb2104-2l-e",io_type="io_parallel",
    )
    hls_model.compile()
    # hls_model.write()
    # hls_model.build()
    report = hls_model.build(reset=True, csim=True, synth=True, cosim=False, validation=False, export=False, vsynth=True, fifo_opt=False)
    print(report)
